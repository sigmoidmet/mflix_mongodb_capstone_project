...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        try {
            ...
            return new UpdateOneModel<>(eq(doc.getObjectId("_id")),
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@cluster0.zfi3wh1.mongodb.net/?retryWrites=true&w=majority";
